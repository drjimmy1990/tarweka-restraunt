...
import { Search, Filter, Calendar, X, ClipboardList } from 'lucide-react';
...
const History: React.FC<HistoryProps> = ({ user }) => {
  ...
  useEffect(() => {
    ...
    const branchOrders = api.getOrders(user.branch_id)
  ...
  const filteredOrders = orders.filter(order => {
    ...
    // Default show DONE, but allow toggle to Cancelled
    ...
    // History page typically for Done/Cancelled, but can show all
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Archived orders for your branch</p>
            </div>
          </div>
